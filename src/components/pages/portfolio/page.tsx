...
const PORTFOLIO_FAQS = [
    { q: "What formats do you design for?", a: "We design for all major formats including hardcover, paperback, and digital eBooks. Our team ensures your cover looks stunning whether it’s on a physical shelf or a digital storefront." },
    { q: "Can I provide my own cover concept?", a: "Absolutely! We love collaborating with authors. If you have a vision or concept, our designers will take your ideas and elevate them into a professional, market-ready cover." },
    { q: "How many revisions are included?", a: "Our design packages include multiple rounds of revisions to ensure you are 100% satisfied. We believe in iterating until your cover perfectly captures the essence of your book." },
    { q: "Do you format the interior layout as well?", a: "Yes, we offer comprehensive interior formatting services for both print and eBook, ensuring your text is clean, professional, and easy to read across all devices." },
    { q: "What is the typical turnaround time for a cover?", a: "Depending on the complexity, most cover designs are completed within 1 to 2 weeks. We always provide a clear timeline before starting the project." },
];
            ...
            <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", position: "relative", zIndex: 4, padding: "120px 360px 100px", paddingTop: "140px", textAlign: "center" }}>
                <div style={{ maxWidth: "820px", width: "100%" }}>
                    <div style={{ display: "inline-flex", alignItems: "center", gap: "12px", marginBottom: "24px", opacity: visible ? 1 : 0, animation: visible ? "ap-fadeUp .5s ease .1s forwards" : "none" }}>
                        ...
                        <span style={{ fontFamily: "'Montserrat',sans-serif", fontSize: ".75rem", letterSpacing: ".3em", color: "#FF4545", fontWeight: 600 }}>OUR PORTFOLIO</span>
                        <div style={{ width: visible ? "32px" : "0", height: "2px", background: "#FF4545", transition: "width .8s ease .3s" }} />
                    </div>
                    <h1 style={{ fontFamily: "'Montserrat',sans-serif", fontWeight: 800, fontSize: "clamp(2rem,3.8vw,3.4rem)", letterSpacing: "-.025em", lineHeight: 1.1, color: "white", margin: "0 0 28px", opacity: visible ? 1 : 0, animation: visible ? "ap-fadeUp .7s ease .2s forwards" : "none" }}>
                        Our Work with <br /><span style={{ color: "#FF4545" }}>Authors Across Genres</span>
                    </h1>
                    <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "1.05rem", lineHeight: 1.85, color: "rgba(255,255,255,.52)", fontWeight: 300, margin: "0 auto 38px", maxWidth: "560px", opacity: visible ? 1 : 0, animation: visible ? "ap-fadeUp .7s ease .38s forwards" : "none" }}>
                        Take a closer look at how we support authors through each stage of their journey. This section highlights selected projects that show our approach, consistency, and the level of detail we maintain across different types of books and services.
                    </p>
                    <div style={{ display: "flex", gap: "14px", justifyContent: "center", flexWrap: "wrap", opacity: visible ? 1 : 0, animation: visible ? "ap-fadeUp .7s ease .5s forwards" : "none" }}>
                        <button className="ap-btn-primary" style={{ fontFamily: "'Montserrat',sans-serif", fontWeight: 700, fontSize: ".92rem", letterSpacing: ".08em", padding: "14px 42px", borderRadius: "999px", background: "linear-gradient(90deg,#fe5858 0%,#FF4545 100%)", color: "#fff", border: "none", cursor: "pointer", boxShadow: "0 8px 28px rgba(255,69,69,.4)" }}>View Showcase</button>
                        <button className="ap-btn-outline" style={{ fontFamily: "'Montserrat',sans-serif", fontWeight: 600, fontSize: ".92rem", letterSpacing: ".06em", padding: "13px 42px", borderRadius: "999px", background: "transparent", color: "rgba(255,255,255,.7)", border: "1px solid rgba(255,255,255,.22)", cursor: "pointer" }}>Get A Quote</button>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div style={{ borderRadius: "26px", background: "linear-gradient(125deg, #1B465F 0%, #16394D 40%, #102A3A 100%)", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "52px 60px 52px 64px", overflow: "hidden", position: "relative", minHeight: "260px" }}>
                        ...
                        <div style={{ position: "relative", zIndex: 5, maxWidth: "540px", flex: "1" }}>
                            <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", marginBottom: "22px", opacity: visible ? 1 : 0, animation: visible ? "fadeUp 0.5s ease forwards" : "none" }}>
                                ...
                                <span style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "0.78rem", letterSpacing: "0.2em", color: "rgba(255,255,255,0.5)" }}>START YOUR PROJECT</span>
                            </div>
                            <h2 style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 800, fontSize: "clamp(2rem, 4.5vw, 3rem)", letterSpacing: "-0.01em", lineHeight: 1.03, color: "white", margin: "0 0 18px" }}>
                                {visible && (<>
                                    <SplitText text="Your Book Is Not" delay={30} duration={1.0} ease="power3.out" splitType="chars" from={{ opacity: 0, y: 35 }} to={{ opacity: 1, y: 0 }} threshold={0.1} rootMargin="-30px" textAlign="left" /><br />
                            ...
                            <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "1.1rem", lineHeight: 1.75, color: "rgba(255,255,255,0.5)", margin: "0 0 34px", fontWeight: 300, maxWidth: "420px", opacity: visible ? 1 : 0, animation: visible ? "fadeUp 0.7s ease 0.35s forwards" : "none" }}>
                                Take the next step with confidence. Let us help you complete your book, publish it, and reach the readers who are waiting for your story.
                            </p>
                        ...
                        <div style={{ position: "absolute", right: "40px", bottom: "20px", height: "400px", zIndex: 4, animation: "floatMockup 5s ease-in-out infinite", filter: `drop-shadow(-20px 10px 50px rgba(0,0,0,0.7)) drop-shadow(0 0 30px rgba(255,69,69,0.12))`, pointerEvents: "none" }}>
                            <img src="/images/Portfolio/MOCKUP.png" alt="Book and tablet mockup" style={{ height: "400px", width: "auto", objectFit: "contain", objectPosition: "top right" }} />
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 400px", gap: "80px", alignItems: "center" }}>
                    <div style={{ opacity: visible ? 1 : 0, animation: visible ? "ap-fadeLeft .85s ease .2s forwards" : "none" }}>
                        ...
                        <h2 style={{ fontFamily: "'Montserrat',sans-serif", fontWeight: 800, fontSize: "clamp(2rem,4vw,3.2rem)", letterSpacing: "-.025em", lineHeight: 1.1, color: "#0A0A0A", marginBottom: "42px" }}>
                            Design & Formatting<br /><span style={{ color: "#FF4545" }}>Questions</span>
                        </h2>
                        <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                            {PORTFOLIO_FAQS.map((faq, i) => {
                ...
                <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 40px" }}>
                    <div style={{ marginBottom: "64px" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "20px", opacity: visible ? 1 : 0, animation: visible ? "fadeUpContact 0.6s ease forwards" : "none" }}>
                            ...
                            <span style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "0.85rem", letterSpacing: "0.25em", color: "#FF4545" }}>START YOUR JOURNEY</span>
                        </div>
